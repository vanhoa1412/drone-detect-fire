...
# Classes (assuming fire and smoke)
...
while True:
    try:
        ...
        for info in result:
            ...
            for box in boxes:
                ...
                if confidence > 50:
                    ...
                    cvzone.putTextRect(frame, f'{classnames[class_name]} {confidence}%', 
        ...
        # Nếu phát hiện lửa, lưu hình ảnh và thông tin vào cơ sở dữ liệu
        if fire_detected:
